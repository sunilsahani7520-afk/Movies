    ...
    >
      ...
      >
        <div className="text-center mb-8">
          <img src={logoImg} alt="NEXTGEN CINEMA" className="w-16 h-16 mx-auto mb-4 rounded-2xl shadow-[0_10px_40px_hsla(170,75%,45%,0.3)]" />
          <h1 className="text-3xl font-extrabold text-primary text-glow">NEXTGEN CINEMA</h1>
        ...
        {!isRegister && (
          <p className="text-center text-xs mt-2">
            <a href="https://t.me/NEXTGEN_CINEMA" target="_blank" rel="noopener noreferrer" className="text-primary/70 hover:text-primary hover:underline">
