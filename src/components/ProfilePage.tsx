      ...
      <motion.div className="fixed inset-0 z-[200] bg-background overflow-y-auto pt-[70px] px-4 pb-24"
        ...
        <div className="space-y-3">
          ...
          <div className="glass-card px-4 py-4 rounded-xl flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium">About NEXTGEN CINEMA</p>
        ...
        {isPremium ? (
          ...
          <>
            <div className="glass-card p-6 rounded-2xl text-center mb-5">
              ...
              <h3 className="text-xl font-bold mb-2">NEXTGEN CINEMA Premium</h3>
            ...
            <div className="glass-card p-4 rounded-2xl mb-4">
              ...
              <input
                ...
                placeholder="NEXTGEN CINEMA-XXXXXX-XXXX"
            ...
            <a href="https://t.me/NEXTGEN_CINEMA" target="_blank" rel="noopener noreferrer"
  ...
  return (
    <motion.div className="fixed inset-0 z-[200] bg-background overflow-y-auto pt-[70px] px-4 pb-24"
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-[10px] text-muted-foreground text-center mt-1 mb-2">Get all updates, news & details about NEXTGEN CINEMA</p>
      </div>
    </motion.div>
  );
};
