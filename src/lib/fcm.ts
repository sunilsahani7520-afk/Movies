...
const VAPID_KEY = "BCXPP6gPtW0YTXECX2Q3pOFSE0O2sTH-oZbQ67WB0ugr8xyxQWKEzI0GayqcH4U-U02VBzqiA9FAduGRccsM1L8";
const SEND_FCM_ENDPOINT = `https://${import.meta.env.VITE_SUPABASE_PROJECT_ID}.supabase.co/functions/v1/send-fcm`;
const APP_ICON_URL = "https://i.ibb.co/fdnZyvB4/IMG-20260325-090648-537-2.jpg";
